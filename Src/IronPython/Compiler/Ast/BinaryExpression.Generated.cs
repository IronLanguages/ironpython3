...
namespace IronPython.Compiler.Ast {
    public partial class BinaryExpression {
        ...
        internal override ConstantExpression ConstantFold() {
            Expression left = Left.ConstantFold();
            Expression right = Right.ConstantFold();
            ...
            try {
                if (constLeft != null && constRight != null &&
                    ...
                    if (constLeft.Value.GetType() == typeof(string) && Operator == PythonOperator.Add) {
                        return new ConstantExpression((string)constLeft.Value + (string)constRight.Value);
                    }
                } else if (Operator == PythonOperator.Multiply && constLeft != null && constRight != null) {
