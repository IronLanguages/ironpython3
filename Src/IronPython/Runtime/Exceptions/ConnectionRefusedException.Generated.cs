...
namespace IronPython.Runtime.Exceptions {
    #region Generated ConnectionRefusedException
    ...
    [Serializable]
    public class ConnectionRefusedException : ConnectionException, IPythonAwareException {
        private object _pyExceptionObject;
        private List<DynamicStackFrame> _frames;
        private TraceBack _traceback;

        public ConnectionRefusedException() : base() { }
        public ConnectionRefusedException(string msg) : base(msg) { }
        public ConnectionRefusedException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected ConnectionRefusedException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        object IPythonAwareException.PythonException {
            get {
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions._OSError(PythonExceptions.ConnectionRefusedError);
