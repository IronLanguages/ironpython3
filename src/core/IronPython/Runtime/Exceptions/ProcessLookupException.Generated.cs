...
namespace IronPython.Runtime.Exceptions {
    #region Generated ProcessLookupException

    // *** BEGIN GENERATED CODE ***
    // generated by function: gen_one_exception_specialized from: generate_exceptions.py

    [Serializable]
    public class ProcessLookupException : OSException, IPythonAwareException {
        ...
        public ProcessLookupException() : base() { }
        public ProcessLookupException(string msg) : base(msg) { }
        public ProcessLookupException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected ProcessLookupException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        PythonExceptions.BaseException? IPythonAwareException.PythonException {
            get {
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions._OSError(PythonExceptions.ProcessLookupError);
