    ...
    */
        ...
        */
        public class sqlite3 {
            ...
            public class sqlite3InitInfo {      /* Information used during initialization */
...
sqlite3 *pNextBlocked;        /* Next in list of all blocked connections */
    ...
    */
        public class FKey {
            ...
            public class sColMap {  /* Mapping of columns in pFrom to columns in zTo */
...
set { _n = value; }
        ...
        */
        public class AggInfo_col {    /* For each column used in source tables */
        ...
        public class AggInfo_func {   /* For each aggregate function */
...
the <column-list> is stored here */
        ...
        */
        public class Walker {
            ...
            public struct uw {                              /* Extra data for callback */
