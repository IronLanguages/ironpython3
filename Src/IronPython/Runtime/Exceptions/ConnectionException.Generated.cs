...
namespace IronPython.Runtime.Exceptions {
    #region Generated ConnectionException
    ...
    [Serializable]
    public class ConnectionException : OSException, IPythonAwareException {
        ...
        object IPythonAwareException.PythonException {
            get {
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions._OSError(PythonExceptions.ConnectionError);
