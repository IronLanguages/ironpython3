...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        #suite.addTest(test.test_float.FormatTestCase('test_format'))
        ...
        #suite.addTest(test.test_float.InfNanTest('test_nan_signs'))
        suite.addTest(test.test_float.ReprTestCase('test_repr'))
        #suite.addTest(test.test_float.ReprTestCase('test_short_repr'))
        #suite.addTest(test.test_float.RoundTestCase('test_format_specials'))
        suite.addTest(test.test_float.RoundTestCase('test_inf_nan'))
        #suite.addTest(test.test_float.RoundTestCase('test_large_n'))
        #suite.addTest(test.test_float.RoundTestCase('test_matches_float_format'))
        #suite.addTest(test.test_float.RoundTestCase('test_overflow'))
        #suite.addTest(test.test_float.RoundTestCase('test_previous_round_bugs'))
