...
namespace IronPython.Runtime.Exceptions {
    #region Generated ConnectionResetException

    // *** BEGIN GENERATED CODE ***
    // generated by function: gen_one_exception_specialized from: generate_exceptions.py

    [Serializable]
    public class ConnectionResetException : ConnectionException, IPythonAwareException {
        ...
        public ConnectionResetException() : base() { }
        public ConnectionResetException(string msg) : base(msg) { }
        ...
        PythonExceptions.BaseException? IPythonAwareException.PythonException {
            get {
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions._OSError(PythonExceptions.ConnectionResetError);
