...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        #suite.addTest(test.test_builtin.BuiltinTest('test_compile'))
        ...
        #suite.addTest(test.test_builtin.BuiltinTest('test_dir'))
        ...
        #suite.addTest(test.test_builtin.BuiltinTest('test_exec_globals'))
        ...
        #suite.addTest(test.test_builtin.BuiltinTest('test_input'))
        ...
        #suite.addTest(test.test_builtin.BuiltinTest('test_len'))
        ...
        #suite.addTest(test.test_builtin.BuiltinTest('test_open_non_inheritable'))
        ...
        #suite.addTest(test.test_builtin.PtyTests('test_input_no_stdout_fileno'))
        #suite.addTest(test.test_builtin.PtyTests('test_input_tty'))
        #suite.addTest(test.test_builtin.PtyTests('test_input_tty_non_ascii'))
        #suite.addTest(test.test_builtin.PtyTests('test_input_tty_non_ascii_unicode_errors'))
