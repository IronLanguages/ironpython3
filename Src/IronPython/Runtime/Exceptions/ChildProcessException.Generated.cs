...
namespace IronPython.Runtime.Exceptions {
    #region Generated ChildProcessException

    // *** BEGIN GENERATED CODE ***
    // generated by function: gen_one_exception_specialized from: generate_exceptions.py

    [Serializable]
    public class ChildProcessException : OSException, IPythonAwareException {
        ...
        public ChildProcessException() : base() { }
        public ChildProcessException(string msg) : base(msg) { }
        public ChildProcessException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected ChildProcessException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        PythonExceptions.BaseException? IPythonAwareException.PythonException {
            get {
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions._OSError(PythonExceptions.ChildProcessError);
