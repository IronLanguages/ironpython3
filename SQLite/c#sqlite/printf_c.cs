...
NULL pointers replaced by SQL NULL.  %Q */
        ...
        */
        public class et_info {   /* Information about each format field */
                ...
                */
                switch (xtype) {
                    ...
                    case etRADIX:
                        ...
                        if (flag_alternateform && infop.prefix != 0) {      /* Add "0" or "0x" */
                            int pre;
                            char x;
                            pre = infop.prefix;
...
for(idx=precision, rounder=0.4999; idx>0; idx--, rounder*=0.1);
        ...
        */
        ...
        static public void sqlite3_snprintf(int n, StringBuilder zBuf, string zFormat, params va_list[] ap) {
            //string z;
            //va_list ap;
            lock (lock_va_list) {//StrAccum acc = new StrAccum( SQLITE_PRINT_BUF_SIZE );
