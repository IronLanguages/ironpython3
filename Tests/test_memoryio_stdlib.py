...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        suite.addTest(test.test_memoryio.CBytesIOTest('test_cow_mutable'))
        suite.addTest(test.test_memoryio.CBytesIOTest('test_cow_setstate'))
        suite.addTest(test.test_memoryio.CBytesIOTest('test_cow_truncate'))
        suite.addTest(test.test_memoryio.CBytesIOTest('test_cow_write'))
        ...
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_newline_argument'))
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_newline_cr'))
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_newline_crlf'))
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_newline_default'))
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_newline_empty'))
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_newline_lf'))
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_newline_none'))
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_newlines_property'))
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_relative_seek'))
        suite.addTest(test.test_memoryio.CStringIOPickleTest('test_textio_properties'))
        ...
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOTest('test_pickling'))) # https://github.com/IronLanguages/ironpython3/issues/1003
        ...
        suite.addTest(test.test_memoryio.CStringIOTest('test_textio_properties'))
