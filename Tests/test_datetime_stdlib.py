...
def load_tests(loader, standard_tests, pattern):
    ...
    if is_ironpython:
        failing_tests = [
            ...
            test.datetimetester.Oddballs('test_bug_1028306'), # AssertionError: False != True
            ...
            test.datetimetester.TestDateTime('test_timestamp_limits'), # AttributeError: 'datetime' object has no attribute 'timestamp'
            ...
            test.datetimetester.TestDateTimeTZ('test_timestamp_limits'), # AttributeError: 'datetime' object has no attribute 'timestamp'
            ...
            test.datetimetester.TestSubclassDateTime('test_timestamp_limits'), # AttributeError: 'datetime' object has no attribute 'timestamp'
