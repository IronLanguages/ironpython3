...
namespace IronPython.Runtime.Exceptions {
    #region Generated TimeoutException
    ...
    [Serializable]
    public class TimeoutException : OSException, IPythonAwareException {
        ...
        object IPythonAwareException.PythonException {
            get {
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions._OSError(PythonExceptions.TimeoutError);
