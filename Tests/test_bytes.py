...
class BytesTest(IronPythonTestCase):
    ...
    def test_endswith(self):
        for testType in types:
            ...
            self.assertTrue(testType(b'abc').endswith((b'xyz', b'abc'), None, (2<<222)))
            self.assertTrue(testType(b'abc').endswith((b'xyz', b'b'), IndexableOC(1), IndexableOC(2)))
            self.assertTrue(testType(b'abc').endswith((b'xyz', memoryview(b'b')), IndexableOC(1), IndexableOC(2)))
            self.assertTrue(testType(b'abc').endswith((b'xyz', memoryview(bytearray(b'b'))), IndexableOC(1), IndexableOC(2)))
