...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        suite.addTest(test.test_sys.SizeofTest('test_asyncgen_hooks'))
        ...
        #suite.addTest(test.test_sys.SysModuleTest('test_exit')) # TODO: slow and fails
        ...
        suite.addTest(test.test_sys.SysModuleTest('test_setrecursionlimit_recursion_depth'))
