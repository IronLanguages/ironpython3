...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        suite.addTest(test.test_socket.GeneralModuleTests('test__sendfile_use_sendfile'))
        ...
        suite.addTest(test.test_socket.GeneralModuleTests('test_host_resolution_bad_address'))
        if is_linux:
        ...
        suite.addTest(test.test_socket.GeneralModuleTests('test_makefile_invalid_mode'))
        suite.addTest(test.test_socket.GeneralModuleTests('test_makefile_mode'))
        ...
        suite.addTest(test.test_socket.GeneralModuleTests('test_sio_loopback_fast_path'))
        ...
        suite.addTest(test.test_socket.LinuxKernelCryptoAPI('test_aead_aes_gcm'))
        suite.addTest(test.test_socket.LinuxKernelCryptoAPI('test_aes_cbc'))
        suite.addTest(test.test_socket.LinuxKernelCryptoAPI('test_drbg_pr_sha256'))
        suite.addTest(test.test_socket.LinuxKernelCryptoAPI('test_hmac_sha1'))
        suite.addTest(test.test_socket.LinuxKernelCryptoAPI('test_length_restriction'))
        suite.addTest(test.test_socket.LinuxKernelCryptoAPI('test_sendmsg_afalg_args'))
        suite.addTest(test.test_socket.LinuxKernelCryptoAPI('test_sha256'))
        ...
        suite.addTest(test.test_socket.TestExceptions('test_setblocking_invalidfd'))
        suite.addTest(test.test_socket.TestLinuxAbstractNamespace('testBytearrayName'))
        ...
        suite.addTest(test.test_socket.TestMSWindowsTCPFlags('test_new_tcp_flags'))
        ...
        suite.addTest(test.test_socket.TestUnixDomain('testUnbound'))
