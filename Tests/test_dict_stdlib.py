...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        #suite.addTest(test.test_dict.DictTest('test_instance_dict_getattr_str_subclass'))
        suite.addTest(test.test_dict.DictTest('test_invalid_keyword_arguments'))
        #suite.addTest(test.test_dict.DictTest('test_itemiterator_pickling'))
        ...
        #suite.addTest(test.test_dict.DictTest('test_merge_and_mutate'))
        ...
        #suite.addTest(test.test_dict.DictTest('test_setdefault_atomic'))
