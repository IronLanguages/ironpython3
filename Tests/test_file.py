...
from iptest import IronPythonTestCase, is_cli, is_mono, is_netcoreapp21, is_netcoreapp30, is_cpython, is_posix, run_test
...
class FileTest(IronPythonTestCase):
    ...
    @unittest.skipIf(is_netcoreapp21 or is_netcoreapp30, "https://github.com/IronLanguages/ironpython2/issues/348")
