...
namespace IronPython.Runtime.Exceptions {
    #region Generated ResourceWarningException
    ...
    [Serializable]
    public class ResourceWarningException : WarningException, IPythonAwareException {
        private object _pyExceptionObject;
        private List<DynamicStackFrame> _frames;
        private TraceBack _traceback;

        public ResourceWarningException() : base() { }
        public ResourceWarningException(string msg) : base(msg) { }
        public ResourceWarningException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected ResourceWarningException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        object IPythonAwareException.PythonException {
            get { 
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions.BaseException(PythonExceptions.ResourceWarning);
