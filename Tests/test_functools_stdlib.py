...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        suite.addTest(test.test_functools.TestLRUC('test_kwargs_order'))
        suite.addTest(test.test_functools.TestLRUC('test_lru'))
        suite.addTest(test.test_functools.TestLRUC('test_lru_cache_decoration'))
        suite.addTest(test.test_functools.TestLRUC('test_lru_cache_threaded'))
        suite.addTest(test.test_functools.TestLRUC('test_lru_cache_threaded2'))
        suite.addTest(test.test_functools.TestLRUC('test_lru_cache_threaded3'))
        ...
        suite.addTest(test.test_functools.TestLRUC('test_pickle'))
        ...
        suite.addTest(test.test_functools.TestLRUPy('test_kwargs_order'))
        ...
        suite.addTest(test.test_functools.TestLRUPy('test_lru_cache_threaded'))
        ...
        suite.addTest(test.test_functools.TestLRUPy('test_pickle'))
        ...
        suite.addTest(test.test_functools.TestPartialC('test_copy'))
        ...
        suite.addTest(test.test_functools.TestPartialC('test_keystr_replaces_value'))
        ...
        suite.addTest(test.test_functools.TestPartialC('test_nested_optimization'))
        ...
        suite.addTest(test.test_functools.TestPartialC('test_recursive_pickle'))
        ...
        suite.addTest(test.test_functools.TestPartialC('test_setstate'))
        ...
        suite.addTest(test.test_functools.TestPartialC('test_setstate_subclasses'))
        ...
        suite.addTest(test.test_functools.TestPartialCSubclass('test_copy'))
        suite.addTest(test.test_functools.TestPartialCSubclass('test_deepcopy'))
        suite.addTest(test.test_functools.TestPartialCSubclass('test_error_propagation'))
        suite.addTest(test.test_functools.TestPartialCSubclass('test_keystr_replaces_value'))
        ...
        suite.addTest(test.test_functools.TestPartialCSubclass('test_recursive_pickle'))
        suite.addTest(test.test_functools.TestPartialCSubclass('test_recursive_repr'))
        suite.addTest(unittest.expectedFailure(test.test_functools.TestPartialCSubclass('test_repr'))) # AssertionError
        suite.addTest(test.test_functools.TestPartialCSubclass('test_setstate'))
        ...
        suite.addTest(test.test_functools.TestPartialCSubclass('test_setstate_subclasses'))
        ...
        suite.addTest(test.test_functools.TestPartialPy('test_recursive_pickle'))
        ...
        suite.addTest(test.test_functools.TestPartialPySubclass('test_recursive_pickle'))
        ...
        suite.addTest(test.test_functools.TestTotalOrdering('test_pickle'))
