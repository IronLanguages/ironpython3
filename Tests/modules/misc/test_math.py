...
class MathTest(IronPythonTestCase):
    ...
    def test_complex(self):
        ...
        self.assertEqual(1+0j, 1)
        self.assertEqual((1+1j)/1, (1+1j))
        self.assertEqual((1j) + 1, (1+1j))
    ...
    def test_floor_divide(self):
        self.assertEqual( (12j//5j), (2+0j))
        self.assertEqual( (12.0+0j) // (5.0+0j), (2+0j) )
        self.assertEqual( (12+0j) // (0+3j), 0j)
        self.assertEqual( (0+12j) // (3+0j), 0j)
        self.assertRaises(TypeError, (lambda:2j // "astring"))
        self.assertRaises(ZeroDivisionError, (lambda:3.0 // (0j)))
        self.assertEqual ( 3.0 // (2j), 0j)
        self.assertEqual( 12 // (3j), 0j)
...
def %s(self, other):
    ...
    def test_long_log(self):
        ...
        self.assertRaises(ValueError, math.log, 2, -1e666)
        self.assertRaises(ZeroDivisionError, math.log, 2, 1.0)
