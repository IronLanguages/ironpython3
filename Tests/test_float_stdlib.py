...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        suite.addTest(test.test_float.FormatTestCase('test_issue35560'))
        ...
        suite.addTest(test.test_float.HexFloatTestCase('test_subclass'))
        ...
        suite.addTest(test.test_float.IEEEFormatTestCase('test_serialized_float_rounding'))
        ...
        suite.addTest(test.test_float.RoundTestCase('test_None_ndigits'))
