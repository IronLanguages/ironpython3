...
memset( pHash, 0, sizeof( sqlite3GlobalFunctions ) );
        ...
        */
        ...
        static public int sqlite3_config(int op, sqlite3_pcache_methods ap) {      //  va_list ap;
            int rc = SQLITE_OK;
            switch (op) {
        ...
        static public int sqlite3_config(int op, ref sqlite3_pcache_methods ap) {      //  va_list ap;
            int rc = SQLITE_OK;
            switch (op) {
        ...
        static public int sqlite3_config(int op, sqlite3_mem_methods ap) {      //  va_list ap;
            int rc = SQLITE_OK;
            switch (op) {
        ...
        static public int sqlite3_config(int op, ref sqlite3_mem_methods ap) {      //  va_list ap;
            int rc = SQLITE_OK;
            switch (op) {
        ...
        */
        public static int sqlite3_close(sqlite3 db) {
            ...
            */
            ...
            for (i = db.aCollSeq.first; i != null; i = i.next) {//sqliteHashFirst(db.aCollSeq); i!=null; i=sqliteHashNext(i)){
...
return rc;
    ...
    ** SQL statement.
    */
        static object sqlite3_trace(sqlite3 db, dxTrace xTrace, object pArg) {// (*xTrace)(void*,const char), object pArg){
            object pOld;
            sqlite3_mutex_enter(db.mutex);
            pOld = db.pTraceArg;
            db.xTrace = xTrace;
             ...
             && nUri >= 5 && memcmp(zUri, "file:", 5) == 0
                ...
                ** method that there may be extra parameters following the file-name.  */
                ...
                if (zUri[5] == '/' && zUri[6] == '/') {
                    ...
                    if (iIn != 7 && (iIn != 16 || !string.Equals("localhost", zUri.Substring(7, 9), StringComparison.OrdinalIgnoreCase)))//memcmp("localhost", &zUri[7], 9)) )
                    {
