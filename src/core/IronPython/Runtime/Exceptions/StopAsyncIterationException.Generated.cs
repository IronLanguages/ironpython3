...
namespace IronPython.Runtime.Exceptions {
    #region Generated StopAsyncIterationException

    // *** BEGIN GENERATED CODE ***
    // generated by function: gen_one_exception_specialized from: generate_exceptions.py

    [Serializable]
    public class StopAsyncIterationException : Exception, IPythonAwareException {
        ...
        public StopAsyncIterationException() : base() { }
        public StopAsyncIterationException(string msg) : base(msg) { }
        public StopAsyncIterationException(string message, Exception innerException)
            : base(message, innerException) {
        }
#if FEATURE_SERIALIZATION
        protected StopAsyncIterationException(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        PythonExceptions.BaseException? IPythonAwareException.PythonException {
            get {
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions._StopAsyncIteration();
