...
return !sqlite3Atoi64(z, pResult, length, enc);
        ...
        */
        ...
        static int getVarint32(byte[] p, out u32 v) { //(*B=*(A))<=0x7f?1:sqlite3GetVarint32(A,B))
            v = p[0];
            if (v <= 0x7F)
                return 1;
        ...
        static int getVarint32(string s, u32 offset, out int v) { //(*B=*(A))<=0x7f?1:sqlite3GetVarint32(A,B))
            v = s[(int)offset];
            if (v <= 0x7F)
                return 1;
        ...
        static int getVarint32(string s, u32 offset, out u32 v) { //(*B=*(A))<=0x7f?1:sqlite3GetVarint32(A,B))
            v = s[(int)offset];
            if (v <= 0x7F)
                return 1;
            pByte4[0] = (u8)s[(int)offset + 0];
        ...
        static int getVarint32(byte[] p, u32 offset, out u32 v) { //(*B=*(A))<=0x7f?1:sqlite3GetVarint32(A,B))
            v = p[offset];
            if (v <= 0x7F)
                return 1;
            return sqlite3GetVarint32(p, (int)offset, out v);
        }
        static int getVarint32(byte[] p, int offset, out u32 v) { //(*B=*(A))<=0x7f?1:sqlite3GetVarint32(A,B))
            v = offset >= p.Length ? 0 : (u32)p[offset];
            if (v <= 0x7F)
                return 1;
            return sqlite3GetVarint32(p, offset, out v);
        }
        static int getVarint32(byte[] p, int offset, out int v) { //(*B=*(A))<=0x7f?1:sqlite3GetVarint32(A,B))
            v = p[offset + 0];
            if (v <= 0x7F)
                return 1;
            u32 u32_v = 0;
