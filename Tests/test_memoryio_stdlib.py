...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CBytesIOTest('test_getbuffer'))) # https://github.com/IronLanguages/ironpython3/issues/1002
        ...
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CBytesIOTest('test_pickling'))) # https://github.com/IronLanguages/ironpython3/issues/1003
        ...
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_issue5265'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_newline_argument'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_newline_cr'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_newline_crlf'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_newline_default'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_newline_empty'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_newline_lf'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_newline_none'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_newlines_property'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_relative_seek'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOPickleTest('test_textio_properties'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        ...
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOTest('test_pickling'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        ...
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOTest('test_textio_properties'))) # https://github.com/IronLanguages/ironpython3/issues/1001
        suite.addTest(test.test_memoryio.CStringIOTest('test_truncate'))
        suite.addTest(unittest.expectedFailure(test.test_memoryio.CStringIOTest('test_widechar'))) # https://github.com/IronLanguages/ironpython3/issues/1001
