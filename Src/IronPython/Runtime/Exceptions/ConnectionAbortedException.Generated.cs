...
namespace IronPython.Runtime.Exceptions {
    #region Generated ConnectionAbortedException
    ...
    [Serializable]
    public class ConnectionAbortedException : ConnectionException, IPythonAwareException {
        private object _pyExceptionObject;
        private List<DynamicStackFrame> _frames;
        private TraceBack _traceback;

        public ConnectionAbortedException() : base() { }
        public ConnectionAbortedException(string msg) : base(msg) { }
        ...
        object IPythonAwareException.PythonException {
            get {
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions._OSError(PythonExceptions.ConnectionAbortedError);
