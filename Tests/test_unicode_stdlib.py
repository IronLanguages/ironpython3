...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        suite.addTest(unittest.expectedFailure(test.test_unicode.UnicodeTest('test_format_huge_precision')))
        suite.addTest(unittest.expectedFailure(test.test_unicode.UnicodeTest('test_format_huge_width')))
