...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        suite.addTest(test.test_long.LongTest('test_floordiv'))
        suite.addTest(test.test_long.LongTest('test_format'))
        suite.addTest(test.test_long.LongTest('test_from_bytes'))
        suite.addTest(test.test_long.LongTest('test_huge_lshift_of_zero'))
        ...
        suite.addTest(test.test_long.LongTest('test_lshift_of_zero'))
        suite.addTest(test.test_long.LongTest('test_mixed_compares'))
        suite.addTest(test.test_long.LongTest('test_mod_division'))
