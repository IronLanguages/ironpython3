...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        #suite.addTest(test.test_re.ReTests('test_bug_13899'))
        #suite.addTest(test.test_re.ReTests('test_bug_1661'))
        ...
        #suite.addTest(test.test_re.ReTests('test_bug_581080'))
        ...
        #suite.addTest(test.test_re.ReTests('test_compile'))
        suite.addTest(test.test_re.ReTests('test_constants'))
        #suite.addTest(test.test_re.ReTests('test_dealloc'))
        #suite.addTest(test.test_re.ReTests('test_debug_flag'))
        ...
        #suite.addTest(test.test_re.ReTests('test_group_name_in_exception'))
        suite.addTest(test.test_re.ReTests('test_groupdict'))
        #suite.addTest(test.test_re.ReTests('test_ignore_case'))
        #suite.addTest(test.test_re.ReTests('test_ignore_case_range'))
        #suite.addTest(test.test_re.ReTests('test_ignore_case_set'))
        suite.addTest(test.test_re.ReTests('test_inline_flags'))
        suite.addTest(test.test_re.ReTests('test_issue17998'))
        #suite.addTest(test.test_re.ReTests('test_keep_buffer'))
        ...
        #suite.addTest(test.test_re.ReTests('test_pickling'))
        suite.addTest(test.test_re.ReTests('test_qualified_re_split'))
        suite.addTest(test.test_re.ReTests('test_qualified_re_sub'))
        #suite.addTest(test.test_re.ReTests('test_re_escape'))
        #suite.addTest(test.test_re.ReTests('test_re_escape_byte'))
        ...
        #suite.addTest(test.test_re.ReTests('test_sre_byte_class_literals'))
        #suite.addTest(test.test_re.ReTests('test_sre_byte_literals'))
        #suite.addTest(test.test_re.ReTests('test_sre_character_class_literals'))
        #suite.addTest(test.test_re.ReTests('test_sre_character_literals'))
        suite.addTest(test.test_re.ReTests('test_stack_overflow'))
        #suite.addTest(test.test_re.ReTests('test_string_boundaries'))
        #suite.addTest(test.test_re.ReTests('test_sub_template_numeric_escape'))
        #suite.addTest(test.test_re.ReTests('test_symbolic_groups'))
        #suite.addTest(test.test_re.ReTests('test_symbolic_refs'))
