...
start = sqlite3Hwtime();
        ...
        */
          ...
          ** Write that value into register P2.
          */
                    case OP_Real: {            /* same as TK_FLOAT, ref2-prerelease */
                            pOut.flags = MEM_Real;
          ...
          */
                    case OP_String8: {         /* same as TK_STRING, ref2-prerelease */
...
pOp.p1 = pOut.n;
              ...
              UPDATE_MAX_BLOBSIZE( pOut );
                    ...
                    ** to avoid a memcpy().
                    */
                    case OP_Concat: {           /* same as TK_CONCAT, in1, in2, ref3 */
                            i64 nByte;
              ...
              UPDATE_MAX_BLOBSIZE( pOut );
                    ...
                    */
                    ...
                    case OP_Remainder: {           /* same as TK_REM, in1, in2, ref3 */
  ...
  if( p.expired ) rc = SQLITE_ABORT;
              ...
              UPDATE_MAX_BLOBSIZE( pOut );
                    ...
                    */
                    ...
                    case OP_ShiftRight: {           /* same as TK_RSHIFT, in1, in2, ref3 */
                            i64 iA;
                            u64 uA;
                            i64 iB;
                            u8 op;
          ...
          */
                    ...
                    */
                    ...
                    case OP_Or: {             /* same as TK_OR, in1, in2, ref3 */
...
** an AUTOINCREMENT table. */
          ...
          */
                    ...
                    */
                    case OP_RowSetRead: {       /* jump, in1, ref3 */
                            i64 val = 0;
                            if (db.u1.isInterrupted)
                                goto abort_due_to_interrupt; //CHECK_FOR_INTERRUPT;
                            pIn1 = aMem[pOp.p1];
