...
def load_tests(loader, standard_tests, pattern):
    if sys.implementation.name == 'ironpython':
        ...
        #suite.addTest(test.test_memoryio.CBytesIOTest('test_getbuffer'))
        ...
        #suite.addTest(test.test_memoryio.CBytesIOTest('test_pickling'))
        ...
        #suite.addTest(test.test_memoryio.CStringIOTest('test_instance_dict_leak'))
        ...
        #suite.addTest(test.test_memoryio.CStringIOTest('test_pickling'))
