...
namespace IronPython.Runtime.Exceptions {
    #region Generated NotADirectoryException

    // *** BEGIN GENERATED CODE ***
    // generated by function: gen_one_exception_specialized from: generate_exceptions.py

    [Serializable]
    public class NotADirectoryException : OSException, IPythonAwareException {
        ...
        public NotADirectoryException() : base() { }
        public NotADirectoryException(string msg) : base(msg) { }
        ...
        PythonExceptions.BaseException? IPythonAwareException.PythonException {
            get {
                if (_pyExceptionObject == null) {
                    var newEx = new PythonExceptions._OSError(PythonExceptions.NotADirectoryError);
